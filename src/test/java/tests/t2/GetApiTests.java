...
public class GetApiTests extends TestBase {
    ...
    @Test(description = "TC01 – GET all objects returns 200 and non-empty array", groups = {"smoke", "t2"})
    ...
    @Test(description = "TC02 – GET single known object by id=1 contains name", groups = {"smoke", "t2"})
